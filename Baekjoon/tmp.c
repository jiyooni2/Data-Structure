...
int main()
{
    ...
    // if(isPowerOfTwo(heap.heap_size))
    // {

    // }
    // else if(isPowerofTwo(heap.heap_size+1))
    // {}
    // else if(isPowerofTwo(heap.heap_size+3))
    // {}
    // else if(isPowerofTwo(heap.heap_size+2))
    // {
